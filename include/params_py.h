...
const String paramSystem PROGMEM = "{'page':["
  ...
  "{"
    ...
    "'minlen':3,"
    "'dt':"+String(PARAM_DT_ST)+","
    "'help':'Wird auch als MQTT und SYSLOG device name genutzt'"
  "},"
  "{"
  ...
  "},"
  "{"
    "'name':"+String(ID_PARAM_MQTT_SERVER_HOST)+","
  ...
  "},"
  "{"
    "'name':"+String(ID_PARAM_SYSLOG_SERVER_ENABLE)+","
    "'label':'SYSLOG enable',"
    "'type':"+String(HTML_INPUTCHECKBOX)+","
    "'default':0,"
    "'dt':"+String(PARAM_DT_BO)+""
  "},"
  "{"
    "'name':"+String(ID_PARAM_SYSLOG_SERVER_HOST)+","
  ...
  "},"
  "{"
    "'name':"+String(ID_PARAM_SYSLOG_SERVER_PORT)+","
  ...
  "},"
  "{"
    "'name':"+String(ID_PARAM_SYSLOG_APP_NAME)+","
    "'label':'SYSLOG App Name',"
    "'type':"+String(HTML_INPUTTEXT)+","
    "'default':'',"
    "'dt':"+String(PARAM_DT_ST)+""
  "},"
